...
OC4 LC 3.2 - NREL 5.0 MW Baseline Wind Turbine for Use in Offshore Analysis. Properties from Dutch Offshore Wind Energy Converter (DOWEC) 6MW Pre-Design (10046_009.pdf) and REpower 5M 5MW (5m_uk.pdf); Compatible with FAST v7.0.
---------------------- SIMULATION CONTROL --------------------------------------
...
"NRELOffshrBsline5MW_OC4DeepCwindSemi_AeroDyn.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"NRELOffshrBsline5MW_OC4DeepCwindSemi_ServoDyn.dat"    SrvDFile        - Name of file containing ServoDyn input parameters (quoted string)
...
True          SumPrint        - Print summary data to "<RootName>.sum" (flag)
       ...
       0.05   DT_Out          - Time step for tabular output (sec)
          0   TStart          - Time to begin tabular output (s)ut (s)
