...
NREL 5.0 MW Baseline Wind Turbine with MIT-NREL TLP Configuration, for use in offshore analysis
---------------------- SIMULATION CONTROL --------------------------------------
...
"NRELOffshrBsline5MW_MIT_NREL_TLP_AeroDyn.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
